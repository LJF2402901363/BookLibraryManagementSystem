...
public class Account implements Serializable {
	...
	@SuppressWarnings("javadoc")
	public Account(int id, String name, String sex, String password, Date createTime, int status, int type,
			String hobby, String signature, int age,String headImgPath) {
		this.id = id;
		this.name = name;
		this.sex = sex;
	...
	public String toString() {
		return "Account{" + "id=" + id + ", name='" + name + '\'' + ", password='" + password + '\'' + ", createTime='"
				+ createTime + '\'' + ", status=" + status + ", type=" + type + '}';
	}
