...
public class Book {
	...
	@SuppressWarnings("javadoc")
	public Book(int id, String name, String author, double price, String type, int status, String description,
			String sbn, Date createTime,String bookImgPath) {
		this.id = id;
		this.name = name;
		this.author = author;
		this.price = price;
	...
	public String toString() {
		return "Book{" + "id=" + id + ", name='" + name + '\'' + ", author='" + author + '\'' + ", price=" + price
				+ ", type='" + type + '\'' + ", status=" + status + ", description='" + description + '\'' + ", sbn='"
				+ sbn + '\'' + '}';
	}
}
