...
public BorrowBookListCellPanel( BorrowBook borrowBook) {
	 ...
	 this.setPreferredSize(new Dimension(450,35));
	 showData();
...
private void showData() {
	if(borrowBook!=null) {
		...
		lbl_bookName.setFont(new Font("微软雅黑",Font.BOLD,16));
		lbl_bookName.setForeground(new Color(47,64,86));
		lbl_time.setText("时间 : "+DateUtil.DateToStr(borrowBook.getBorrowTime()));
		lbl_time.setFont(new Font("微软雅黑",Font.ITALIC,16));
	}
